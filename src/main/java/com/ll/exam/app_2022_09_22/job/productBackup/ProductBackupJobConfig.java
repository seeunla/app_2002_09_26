...
public class ProductBackupJobConfig {
    ...
    public Step productBackupStep1(
            ...
            ItemProcessor productToProductBackupProssesor,
    ...
    )
    {
        return stepBuilderFactory.get("productBackupStep1")
                ...
                .processor(productToProductBackupProssesor)
    ...
    @Bean
    @StepScope
    public ItemProcessor<Product, ProductBackup> productToProductBackupProssesor() {
